...
target_detectionB=pose_e(5.4,-5,220)
...
#后
target_detectionF7=pose_e(0.5,-4.6,325)
#右
target_detectionF8=pose_e(0.20,-4.4,45)
target_detectionF9=pose_e(0.20,-2.5,300)
#出
target_detectionF10=pose_e(0.9,-2,90)
target_detectionF11=pose_e(0.9,-1,90)


# ---------------------------设定停车位置目标-----------------------------------
target_parking = pose_e(-0.1,0.2,180)
# target_parking = pose_e(-0.08,0.23,180)
# 
targets=[
        target_detectionD,
        target_detectionB,
